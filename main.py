...
from src.create_subsplans_xml.create_subplans_xml import SubplanGenerator
...
def handle_gen_report(args):
    ...
    parser = ResultXMLParser(args.path,args.time_unit,args.output_dir)
...
def handle_multi_gen_report(args):
    ...
    parser = MultiResultXMLParser(args.path,args.time_unit,args.output_dir)
...
def handle_gen_report_CTS_V(args):
    ...
    parser = ResultXMLParser_CTS_V(args.path,args.time_unit,args.output_dir)
    parser.parser_all_modules()
...
def main():
    ...
    report_parser.add_argument("--output_dir", default=base_dir+'/result/CTS', help="Save result excel folder")
    ...
    report_ctsV_parser.add_argument("--output_dir", default=base_dir+'/result/CTSV', help="Save result excel folder")
